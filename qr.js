                    ...
                    try {
                        ...
                        if (userJid) {
                            ...
                            await sock.sendMessage(userJid, {
                                ...
                                caption: `🎬 *Bon maintenant rejoins nous [https://whatsapp.com/channel/0029Vb6s5JpDzgT69NCS7i1a]* Tu peux aussi rejoindre notre communauté de devs et mods [en me contactant sur discord ou slack]`
                            });
                            console.log("🎬 Video guide sent successfully");
                            
                            // Send warning message
                            await sock.sendMessage(userJid, {
                                text: `⚠️Ne partage surtout pas ce fichier en aucun cas même si c'est l'un de mes partenaires qui te le demande⚠️\n 
